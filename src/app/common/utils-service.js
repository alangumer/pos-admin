...
.factory('utils', ['$filter', function ($filter) {
  return {
    ...
    crearPDF : function ( idexpediente, datosCaratula, barra, arreglo ) {
      var juez='';        
      // aqui empieza la caratula
      var consolidado= datosCaratula[2].COL3 + ' - ' + datosCaratula[2].COL1 + ' - '  +  datosCaratula[2].COL2;
      ...
      var content = [
        {
          ...
          },
          {
            width: '*',
            style: 'header',
            text: datosCaratula[1].COL1 + ' - ' + datosCaratula[1].COL2 ,
          }]
        },
        {
        ...
        {
          style: 'expediente',
          text: 'Número Único del Expediente'
        },
        {
          style: 'expediente',
          text: idexpediente
        ...
        {
          style: 'segundo',
          text:  $filter('date')(new Date(datosCaratula[0].COL5),'dd/MM/yyyy HH:mm')
        },
      ];
      ...
      content.push({
        style: 'actor',
        text: datosCaratula[1].COL3 ? datosCaratula[1].COL3 : ''
      });
      ...
      var docDefinition = {
        ...
        footer: {
          columns: [
            { style: 'foot', text: 'Fecha y hora de Asignación: ' + $filter('date')(new Date(datosCaratula[0].COL4),'dd/MM/yyyy HH:mm')},
            { style: 'foot', text: 'Ingresado por: ' + datosCaratula[0].COL1 }
          ]
        },
